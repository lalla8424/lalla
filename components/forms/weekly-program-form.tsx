...
import { submitWeeklyProgramForm } from "../../actions/form-actions";
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="border-l-4 border-[#FFD700]/30 pl-4 mb-6">
          ...
          <p className="text-sm text-gray-600 mb-2">
            A fun, hands-on art program designed to spark your child's
            imagination and creativity!
            <br />
            Kids explore art through picture books, storytelling, basic drawing,
            sculpture, installation art, beam projection murals, and
          ...
          <div>
            ...
            <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
              <li>
                4-week program (1 class per week / total of 4 sessions):{" "}
                <span className="text-xs font-light">
                  190,000 KRW for 70mins
                </span>{" "}
                (includes all materials)
              </li>
              <li>
                Optional Art Photobook:{" "}
                <span className="text-xs font-light">40,000 KRW</span> (includes
                photos from 10 sessions, professionally designed)
              </li>
            </ul>
          </div>
        </div>
